...
<div class="row shadow shadow-lg mx-lg-5 px-lg-5 py-3 mb-lg-5">
  ...
  <div class="col-12 mt-3">
    ...
    <input type="text" id="teamOne" class="form-control form-control-lg text-white bg-dark" >
  </div>
  <div class="col-12 mt-3">
    <label class="form-label text-success h5">Team 2:</label>
    <input type="text" id="teamTwo" class="form-control form-control-lg text-white bg-dark" value="">
  </div>
  <div class="col-12 mt-3">
